<template>
  <div class="navBar">
		...
		<div class="actionButtons">
			...
			<!-- <button class="btn btnPrint" v-print="printObj">Agenda</button> -->
			<!-- <button class="btn btnPrint" @click="print">Minutes</button> -->
...
// using add in from https://github.com/Power-kxLee/vue-print-nb
